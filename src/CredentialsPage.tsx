  ...
  useEffect(() => {
    const fetchCredentials = async () => {
      try {
        ...
        console.log('Extracted workspace from auth:', workspace);
        ...
        if (workspace) {
          ...
          console.log('No workspace found in auth, using default');
        }
        ...
        console.log('✓ Successfully fetched credentials for workspace:', data.workspace);
        setCredentials(data);
      } catch (err) {
